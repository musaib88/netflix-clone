          ...
          <div id="container-login-form">
            ...
            <form action="/browse">
              <div className="input-div">
                ...
                <div
                  className={
                    labelEmail ? "label-postion-sp-after" : "label-postion-sp"
                  }
                >
              ...
              <div className="input-div">
                ...
                <div className={passwordToggle ? "show" : "show-hide"}>
                  <label htmlFor="password-signin-p" onClick={handleShow}>
              ...
              <div id="labels">
                ...
                <div id="need-help">
                  <a href="https://www.netflix.com/in/LoginHelp">
                    <span>Need help?</span>
                  </a>
                </div>
              </div>
